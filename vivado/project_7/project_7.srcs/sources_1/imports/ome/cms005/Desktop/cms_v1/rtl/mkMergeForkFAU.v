...
//
// On Wed Jun 19 15:57:42 CDT 2013
//
...
module mkMergeForkFAU(CLK,
  ...
  wire [133 : 0] MUX_ackEgressF_enq_1__VAL_2;
  wire MUX_control_write_1__VAL_1,
       MUX_control_write_1__VAL_2,
       MUX_isAckHeader_write_1__SEL_1,
       MUX_isDGheader_write_1__PSEL_1,
       MUX_isDGheader_write_1__SEL_1,
       MUX_isDGheader_write_1__SEL_2;
  ...
  // rule RL_rmDGheader
  assign CAN_FIRE_RL_rmDGheader = MUX_isDGheader_write_1__SEL_2 ;
  assign WILL_FIRE_RL_rmDGheader = MUX_isDGheader_write_1__SEL_2 ;

  // rule RL_pumpFrame1
  assign CAN_FIRE_RL_pumpFrame1 =
	     datagramIngressF_EMPTY_N && datagramEgressF1_FULL_N &&
  ...
  assign CAN_FIRE_RL_pumpHeader =
	     ackEgressF_FULL_N && isAckHeader && ackIngressF_EMPTY_N ;
  assign WILL_FIRE_RL_pumpHeader = CAN_FIRE_RL_pumpHeader ;

  // rule RL_pumpAck
  assign CAN_FIRE_RL_pumpAck =
	     ackEgressF_FULL_N && ackIngressF_EMPTY_N && !isAckHeader ;
  ...
  assign MUX_isDGheader_write_1__PSEL_1 =
	     WILL_FIRE_RL_pumpFrame2 || WILL_FIRE_RL_pumpFrame1 ;
  assign MUX_isDGheader_write_1__SEL_1 =
	     MUX_isDGheader_write_1__PSEL_1 && datagramIngressF_D_OUT[0] ;
  assign MUX_isDGheader_write_1__SEL_2 =
	     datagramIngressF_EMPTY_N && isDGheader ;
  assign MUX_ackEgressF_enq_1__VAL_2 =
  ...
  // register isDGheader
  assign isDGheader_D_IN = MUX_isDGheader_write_1__SEL_1 ;
  ...
  assign ackEgressF_D_IN =
	     WILL_FIRE_RL_pumpAck ?
	       ackIngressF_D_OUT :
	       MUX_ackEgressF_enq_1__VAL_2 ;
  assign ackEgressF_ENQ = WILL_FIRE_RL_pumpAck || WILL_FIRE_RL_pumpHeader ;
  ...
  assign datagramIngressF_DEQ =
	     WILL_FIRE_RL_rmDGheader || WILL_FIRE_RL_pumpFrame2 ||
	     WILL_FIRE_RL_pumpFrame1 ;
  ...
  begin
	...
	macDst <= `BSV_ASSIGNMENT_DELAY 48'hFFFFFFFFFFFF;
