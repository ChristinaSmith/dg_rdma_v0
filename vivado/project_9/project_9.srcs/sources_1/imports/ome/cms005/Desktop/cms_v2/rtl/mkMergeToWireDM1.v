...
//
// On Sun Jun 23 17:46:54 CDT 2013
//
...
module mkMergeToWireDM1(CLK,
  ...
  assign CAN_FIRE_RL_assignArbiter = 1'd1 ;
  assign WILL_FIRE_RL_assignArbiter = !WILL_FIRE_RL_funnelAck ;
  ...
  assign MUX_arbiterOut_write_1__VAL_3 =
  ...
  // register arbiterOut
  always@(WILL_FIRE_RL_assignArbiter or
	  ackIngressRcvF_EMPTY_N or
	  WILL_FIRE_RL_funnelDatagram or
	  MUX_arbiterOut_write_1__VAL_2 or
	  WILL_FIRE_RL_funnelAck or MUX_arbiterOut_write_1__VAL_3)
  case (1'b1)
    WILL_FIRE_RL_assignArbiter: arbiterOut_D_IN = ackIngressRcvF_EMPTY_N;
    WILL_FIRE_RL_funnelDatagram:
	arbiterOut_D_IN = MUX_arbiterOut_write_1__VAL_2;
    WILL_FIRE_RL_funnelAck: arbiterOut_D_IN = MUX_arbiterOut_write_1__VAL_3;
    default: arbiterOut_D_IN = 1'b0 /* unspecified value */ ;
  endcase
  assign arbiterOut_EN =
	     WILL_FIRE_RL_assignArbiter || WILL_FIRE_RL_funnelAck ||
	     WILL_FIRE_RL_funnelDatagram ;
