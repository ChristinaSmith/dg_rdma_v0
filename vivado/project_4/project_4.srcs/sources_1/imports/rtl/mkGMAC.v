...
//
// On Sun Jun 16 16:18:46 CDT 2013
//
...
module mkGMAC(CLK_rxClk,
  ...
  wire rxRS_preambleCnt_incAction_whas,
  ...
  wire CAN_FIRE_RL_rxRS_crcDbgCnt_ruleDec,
       CAN_FIRE_RL_rxRS_crcDbgCnt_ruleInc,
       CAN_FIRE_RL_rxRS_crc_capture,
       CAN_FIRE_RL_rxRS_dv_reg,
       CAN_FIRE_RL_rxRS_egress_data,
       CAN_FIRE_RL_rxRS_end_frame,
       CAN_FIRE_RL_rxRS_full_stretch,
       CAN_FIRE_RL_rxRS_ingress_advance,
       CAN_FIRE_RL_rxRS_ingress_noadvance,
       CAN_FIRE_RL_rxRS_operate_condition,
       CAN_FIRE_RL_rxRS_overflow_detect,
       CAN_FIRE_RL_rxRS_preambleCnt_ruleDec,
       CAN_FIRE_RL_rxRS_preambleCnt_ruleInc,
       CAN_FIRE_RL_rxRS_rxOperateD__dreg_update,
       CAN_FIRE_RL_txRS_crcDbgCnt_ruleDec,
       CAN_FIRE_RL_txRS_crcDbgCnt_ruleInc,
       CAN_FIRE_RL_txRS_egress_Body,
       CAN_FIRE_RL_txRS_egress_EOF,
       CAN_FIRE_RL_txRS_egress_FCS,
       CAN_FIRE_RL_txRS_egress_SOF,
       CAN_FIRE_RL_txRS_ifgCnt_ruleDec,
       CAN_FIRE_RL_txRS_ifgCnt_ruleInc,
       CAN_FIRE_RL_txRS_ifg_decrementer,
       CAN_FIRE_RL_txRS_lenCnt_ruleDec,
       CAN_FIRE_RL_txRS_lenCnt_ruleInc,
       CAN_FIRE_RL_txRS_operate_condition,
       CAN_FIRE_RL_txRS_preambleCnt_ruleDec,
       CAN_FIRE_RL_txRS_preambleCnt_ruleInc,
       CAN_FIRE_RL_txRS_txDV__dreg_update,
       CAN_FIRE_RL_txRS_txData__dreg_update,
       CAN_FIRE_RL_txRS_txER__dreg_update,
       CAN_FIRE_RL_txRS_txOperateD__dreg_update,
       CAN_FIRE_RL_txRS_tx_output_flops,
       CAN_FIRE_RL_txRS_undeflow_detect,
       CAN_FIRE_RL_txRS_underflow__dreg_update,
       CAN_FIRE_RL_txRS_unf_stretch,
       CAN_FIRE_gmii_col,
       CAN_FIRE_gmii_crs,
       CAN_FIRE_gmii_intr,
       ...
       CAN_FIRE_txOperate,
       CAN_FIRE_tx_put,
       WILL_FIRE_RL_rxRS_crcDbgCnt_ruleDec,
       WILL_FIRE_RL_rxRS_crcDbgCnt_ruleInc,
       WILL_FIRE_RL_rxRS_crc_capture,
       WILL_FIRE_RL_rxRS_dv_reg,
       WILL_FIRE_RL_rxRS_egress_data,
       WILL_FIRE_RL_rxRS_end_frame,
       WILL_FIRE_RL_rxRS_full_stretch,
       WILL_FIRE_RL_rxRS_ingress_advance,
       WILL_FIRE_RL_rxRS_ingress_noadvance,
       WILL_FIRE_RL_rxRS_operate_condition,
       WILL_FIRE_RL_rxRS_overflow_detect,
       WILL_FIRE_RL_rxRS_preambleCnt_ruleDec,
       WILL_FIRE_RL_rxRS_preambleCnt_ruleInc,
       WILL_FIRE_RL_rxRS_rxOperateD__dreg_update,
       WILL_FIRE_RL_txRS_crcDbgCnt_ruleDec,
       WILL_FIRE_RL_txRS_crcDbgCnt_ruleInc,
       WILL_FIRE_RL_txRS_egress_Body,
       WILL_FIRE_RL_txRS_egress_EOF,
       WILL_FIRE_RL_txRS_egress_FCS,
       WILL_FIRE_RL_txRS_egress_SOF,
       WILL_FIRE_RL_txRS_ifgCnt_ruleDec,
       WILL_FIRE_RL_txRS_ifgCnt_ruleInc,
       WILL_FIRE_RL_txRS_ifg_decrementer,
       WILL_FIRE_RL_txRS_lenCnt_ruleDec,
       WILL_FIRE_RL_txRS_lenCnt_ruleInc,
       WILL_FIRE_RL_txRS_operate_condition,
       WILL_FIRE_RL_txRS_preambleCnt_ruleDec,
       WILL_FIRE_RL_txRS_preambleCnt_ruleInc,
       WILL_FIRE_RL_txRS_txDV__dreg_update,
       WILL_FIRE_RL_txRS_txData__dreg_update,
       WILL_FIRE_RL_txRS_txER__dreg_update,
       WILL_FIRE_RL_txRS_txOperateD__dreg_update,
       WILL_FIRE_RL_txRS_tx_output_flops,
       WILL_FIRE_RL_txRS_undeflow_detect,
       WILL_FIRE_RL_txRS_underflow__dreg_update,
       WILL_FIRE_RL_txRS_unf_stretch,
       WILL_FIRE_gmii_col,
       WILL_FIRE_gmii_crs,
       WILL_FIRE_gmii_intr,
  ...
  assign CAN_FIRE_rx_get = rxRS_rxF_dEMPTY_N ;
  assign WILL_FIRE_rx_get = EN_rx_get ;

  // action method tx_put
  assign RDY_tx_put = txRS_txF_sFULL_N ;
  assign CAN_FIRE_tx_put = txRS_txF_sFULL_N ;
  ...
  // rule RL_rxRS_operate_condition
  assign CAN_FIRE_RL_rxRS_operate_condition = 1'd1 ;
  assign WILL_FIRE_RL_rxRS_operate_condition = 1'd1 ;

  // rule RL_rxRS_overflow_detect
  assign CAN_FIRE_RL_rxRS_overflow_detect = rxRS_rxOperateS_dD_OUT ;
  assign WILL_FIRE_RL_rxRS_overflow_detect = rxRS_rxOperateS_dD_OUT ;

  // rule RL_rxRS_full_stretch
  assign CAN_FIRE_RL_rxRS_full_stretch = 1'd1 ;
  assign WILL_FIRE_RL_rxRS_full_stretch = 1'd1 ;

  // rule RL_rxRS_ingress_noadvance
  assign CAN_FIRE_RL_rxRS_ingress_noadvance =
  ...
  // rule RL_rxRS_crc_capture
  assign CAN_FIRE_RL_rxRS_crc_capture =
	     rxRS_rxOperateS_dD_OUT && rxRS_rxDV && rxRS_rxAPipe[3] ;
  assign WILL_FIRE_RL_rxRS_crc_capture = CAN_FIRE_RL_rxRS_crc_capture ;

  // rule RL_rxRS_egress_data
  assign CAN_FIRE_RL_rxRS_egress_data =
	     rxRS_rxF_sFULL_N && rxRS_rxOperateS_dD_OUT && rxRS_rxDVD &&
	     rxRS_rxAPipe[5] ;
  assign WILL_FIRE_RL_rxRS_egress_data = CAN_FIRE_RL_rxRS_egress_data ;

  // rule RL_rxRS_dv_reg
  assign CAN_FIRE_RL_rxRS_dv_reg = rxRS_rxOperateS_dD_OUT ;
  assign WILL_FIRE_RL_rxRS_dv_reg = rxRS_rxOperateS_dD_OUT ;

  // rule RL_rxRS_ingress_advance
  assign CAN_FIRE_RL_rxRS_ingress_advance =
	     rxRS_rxOperateS_dD_OUT && rxRS_rxDV && !rxRS_rxER ;
  assign WILL_FIRE_RL_rxRS_ingress_advance =
	     CAN_FIRE_RL_rxRS_ingress_advance ;

  // rule RL_rxRS_rxOperateD__dreg_update
  assign CAN_FIRE_RL_rxRS_rxOperateD__dreg_update = 1'd1 ;
  assign WILL_FIRE_RL_rxRS_rxOperateD__dreg_update = 1'd1 ;

  // rule RL_rxRS_preambleCnt_ruleInc
  assign CAN_FIRE_RL_rxRS_preambleCnt_ruleInc =
	     rxRS_preambleCnt_incAction_whas ;
  assign WILL_FIRE_RL_rxRS_preambleCnt_ruleInc =
	     rxRS_preambleCnt_incAction_whas ;

  // rule RL_rxRS_preambleCnt_ruleDec
  assign CAN_FIRE_RL_rxRS_preambleCnt_ruleDec = 1'b0 ;
  assign WILL_FIRE_RL_rxRS_preambleCnt_ruleDec = 1'b0 ;

  // rule RL_rxRS_end_frame
  assign CAN_FIRE_RL_rxRS_end_frame =
  ...
  assign CAN_FIRE_RL_rxRS_crcDbgCnt_ruleInc = CAN_FIRE_RL_rxRS_crc_capture ;
  assign WILL_FIRE_RL_rxRS_crcDbgCnt_ruleInc =
	     CAN_FIRE_RL_rxRS_crc_capture &&
	     !WILL_FIRE_RL_rxRS_ingress_noadvance ;

  // rule RL_rxRS_crcDbgCnt_ruleDec
  assign CAN_FIRE_RL_rxRS_crcDbgCnt_ruleDec = 1'b0 ;
  assign WILL_FIRE_RL_rxRS_crcDbgCnt_ruleDec = 1'b0 ;

  // rule RL_txRS_operate_condition
  assign CAN_FIRE_RL_txRS_operate_condition = 1'd1 ;
  assign WILL_FIRE_RL_txRS_operate_condition = 1'd1 ;

  // rule RL_txRS_undeflow_detect
  assign CAN_FIRE_RL_txRS_undeflow_detect = txRS_txOperateS_dD_OUT ;
  assign WILL_FIRE_RL_txRS_undeflow_detect = txRS_txOperateS_dD_OUT ;

  // rule RL_txRS_unf_stretch
  assign CAN_FIRE_RL_txRS_unf_stretch = 1'd1 ;
  assign WILL_FIRE_RL_txRS_unf_stretch = 1'd1 ;
  ...
  // rule RL_txRS_ifg_decrementer
  assign CAN_FIRE_RL_txRS_ifg_decrementer =
	     txRS_txOperateS_dD_OUT && txRS_ifgCnt_value != 5'h0 ;
  assign WILL_FIRE_RL_txRS_ifg_decrementer =
	     CAN_FIRE_RL_txRS_ifg_decrementer ;

  // rule RL_txRS_tx_output_flops
  assign CAN_FIRE_RL_txRS_tx_output_flops = 1'd1 ;
  assign WILL_FIRE_RL_txRS_tx_output_flops = 1'd1 ;

  // rule RL_txRS_txOperateD__dreg_update
  assign CAN_FIRE_RL_txRS_txOperateD__dreg_update = 1'd1 ;
  assign WILL_FIRE_RL_txRS_txOperateD__dreg_update = 1'd1 ;

  // rule RL_txRS_txER__dreg_update
  assign CAN_FIRE_RL_txRS_txER__dreg_update = 1'd1 ;
  assign WILL_FIRE_RL_txRS_txER__dreg_update = 1'd1 ;

  // rule RL_txRS_preambleCnt_ruleInc
  assign CAN_FIRE_RL_txRS_preambleCnt_ruleInc = WILL_FIRE_RL_txRS_egress_SOF ;
  assign WILL_FIRE_RL_txRS_preambleCnt_ruleInc =
	     WILL_FIRE_RL_txRS_egress_SOF ;

  // rule RL_txRS_preambleCnt_ruleDec
  assign CAN_FIRE_RL_txRS_preambleCnt_ruleDec = 1'b0 ;
  assign WILL_FIRE_RL_txRS_preambleCnt_ruleDec = 1'b0 ;

  // rule RL_txRS_ifgCnt_ruleInc
  assign CAN_FIRE_RL_txRS_ifgCnt_ruleInc = 1'b0 ;
  assign WILL_FIRE_RL_txRS_ifgCnt_ruleInc = 1'b0 ;

  // rule RL_txRS_ifgCnt_ruleDec
  assign CAN_FIRE_RL_txRS_ifgCnt_ruleDec = CAN_FIRE_RL_txRS_ifg_decrementer ;
  assign WILL_FIRE_RL_txRS_ifgCnt_ruleDec = CAN_FIRE_RL_txRS_ifg_decrementer ;

  // rule RL_txRS_egress_FCS
  assign CAN_FIRE_RL_txRS_egress_FCS =
	     txRS_txOperateS_dD_OUT && txRS_emitFCS != 3'd0 ;
  assign WILL_FIRE_RL_txRS_egress_FCS = CAN_FIRE_RL_txRS_egress_FCS ;

  // rule RL_txRS_txData__dreg_update
  assign CAN_FIRE_RL_txRS_txData__dreg_update = 1'd1 ;
  assign WILL_FIRE_RL_txRS_txData__dreg_update = 1'd1 ;

  // rule RL_txRS_txDV__dreg_update
  assign CAN_FIRE_RL_txRS_txDV__dreg_update = 1'd1 ;
  assign WILL_FIRE_RL_txRS_txDV__dreg_update = 1'd1 ;

  // rule RL_txRS_lenCnt_ruleInc
  assign CAN_FIRE_RL_txRS_lenCnt_ruleInc = txRS_lenCnt_incAction_whas ;
  assign WILL_FIRE_RL_txRS_lenCnt_ruleInc =
	     txRS_lenCnt_incAction_whas && !WILL_FIRE_RL_txRS_egress_FCS ;

  // rule RL_txRS_lenCnt_ruleDec
  assign CAN_FIRE_RL_txRS_lenCnt_ruleDec = 1'b0 ;
  assign WILL_FIRE_RL_txRS_lenCnt_ruleDec = 1'b0 ;

  // rule RL_txRS_crcDbgCnt_ruleInc
  assign CAN_FIRE_RL_txRS_crcDbgCnt_ruleInc = txRS_crcDbgCnt_incAction_whas ;
  assign WILL_FIRE_RL_txRS_crcDbgCnt_ruleInc =
	     txRS_crcDbgCnt_incAction_whas && !WILL_FIRE_RL_txRS_egress_FCS ;

  // rule RL_txRS_crcDbgCnt_ruleDec
  assign CAN_FIRE_RL_txRS_crcDbgCnt_ruleDec = 1'b0 ;
  assign WILL_FIRE_RL_txRS_crcDbgCnt_ruleDec = 1'b0 ;

  // rule RL_txRS_underflow__dreg_update
  assign CAN_FIRE_RL_txRS_underflow__dreg_update = 1'd1 ;
  assign WILL_FIRE_RL_txRS_underflow__dreg_update = 1'd1 ;
  ...
  assign rxRS_rxPipe_EN = CAN_FIRE_RL_rxRS_ingress_advance ;
  ...
  assign rxRS_crc_EN_add = CAN_FIRE_RL_rxRS_crc_capture ;
  assign rxRS_crc_EN_clear = 1'b0 ;
  assign rxRS_crc_EN_complete = CAN_FIRE_RL_rxRS_ingress_noadvance ;
