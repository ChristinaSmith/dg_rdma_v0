...
//
// On Sun Jun 16 16:18:51 CDT 2013
//
...
module mkGbeQABS(CLK_gmii_rx_clk,
  ...
  // output resets
  assign RST_N_gmii_rstn = RST_N_gmiixo_rst ;
  ...
  // register mdi_rMDD
  assign mdi_rMDD_D_IN = bs__h2459[mdi_rPlayIndex_Q_OUT] ;
  assign mdi_rMDD_EN = CAN_FIRE_RL_mdi_run_frame ;

  // register mdi_rOutEn
  assign mdi_rOutEn_D_IN = bs__h15218[mdi_rPlayIndex_Q_OUT] ;
  ...
  // register phyMdiInit
  assign phyMdiInit_D_IN = 1'b0 ;
  assign phyMdiInit_EN = 1'b0 ;

  // register phyResetWaitCnt
  assign phyResetWaitCnt_D_IN = 25'h0 ;
  assign phyResetWaitCnt_EN = 1'b0 ;
  ...
  // submodule mdi_fResponse
  assign mdi_fResponse_D_IN = { 1'd1, x_data__h18495 } ;
  ...
  assign qbgmac_EN_rxOperate = 1'd1 ;
  assign qbgmac_EN_txOperate = 1'd1 ;
  ...
  assign bs__h2459 =
		 ...
		 108'hFFFFFFFFFFFFFFFFFFFFFFFF1F8,
	       ...
	       d0__h2085,
	       3'b111 } ;
  assign d0__h2085 = {3{mdi_rWriteData[0]}} ;
  assign d10__h2075 = {3{mdi_rWriteData[10]}} ;
  assign d11__h2074 = {3{mdi_rWriteData[11]}} ;
  assign d12__h2073 = {3{mdi_rWriteData[12]}} ;
  assign d13__h2072 = {3{mdi_rWriteData[13]}} ;
  assign d14__h2071 = {3{mdi_rWriteData[14]}} ;
  assign d15__h2070 = {3{mdi_rWriteData[15]}} ;
  assign d1__h2084 = {3{mdi_rWriteData[1]}} ;
  assign d2__h2083 = {3{mdi_rWriteData[2]}} ;
  assign d3__h2082 = {3{mdi_rWriteData[3]}} ;
  assign d4__h2081 = {3{mdi_rWriteData[4]}} ;
  assign d5__h2080 = {3{mdi_rWriteData[5]}} ;
  assign d6__h2079 = {3{mdi_rWriteData[6]}} ;
  assign d7__h2078 = {3{mdi_rWriteData[7]}} ;
  assign d8__h2077 = {3{mdi_rWriteData[8]}} ;
  assign d9__h2076 = {3{mdi_rWriteData[9]}} ;
  assign pa0__h2062 = {3{mdi_rPhyAddr[0]}} ;
  assign pa1__h2061 = {3{mdi_rPhyAddr[1]}} ;
  assign pa2__h2060 = {3{mdi_rPhyAddr[2]}} ;
  assign pa3__h2059 = {3{mdi_rPhyAddr[3]}} ;
  assign pa4__h2058 = {3{mdi_rPhyAddr[4]}} ;
  assign ra0__h2068 = {3{mdi_rRegAddr[0]}} ;
  assign ra1__h2067 = {3{mdi_rRegAddr[1]}} ;
  assign ra2__h2066 = {3{mdi_rRegAddr[2]}} ;
  assign ra3__h2065 = {3{mdi_rRegAddr[3]}} ;
  assign ra4__h2064 = {3{mdi_rRegAddr[4]}} ;
  assign x_data__h18495 =
	     { mdi_vrReadData_15,
	       mdi_vrReadData_14,
	       mdi_vrReadData_13,
	       mdi_vrReadData_12,
