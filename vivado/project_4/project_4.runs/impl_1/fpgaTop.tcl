...
set rc [catch {
  ...
  add_files /home/cms005/Desktop/cms_v0/vivado/project_4/project_4.runs/synth_1/fpgaTop.dcp
  read_xdc /home/cms005/Desktop/cms_v0/vivado/project_4/project_4.srcs/constrs_1/imports/constrs/kc705.xdc
  link_design -top fpgaTop -part xc7k325tffg900-2
...
set rc [catch {
  ...
  catch { report_incremental_reuse -file fpgaTop_incremental_reuse_placed.rpt }
...
set rc [catch {
  ...
  catch { report_timing_summary -label_reused -file fpgaTop_timing_summary_routed.rpt -pb fpgaTop_timing_summary_routed.pb }
