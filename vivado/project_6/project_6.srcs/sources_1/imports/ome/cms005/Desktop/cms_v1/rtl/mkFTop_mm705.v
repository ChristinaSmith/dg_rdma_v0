...
//
// On Sun Jun 16 19:23:24 CDT 2013
//
...
module mkFTop_mm705(CLK_sys1_clkp,
  ...
  reg [1 : 0] CASE_gmacrx_get_BITS_19_TO_18_0_gmacrx_get_B_ETC__q9,
	      CASE_gmacrx_get_BITS_29_TO_28_0_gmacrx_get_B_ETC__q8,
	      CASE_gmacrx_get_BITS_39_TO_38_0_gmacrx_get_B_ETC__q7,
	      CASE_gmacrx_get_BITS_9_TO_8_0_gmacrx_get_BIT_ETC__q10,
	      CASE_hbdg2qabsqabs_response_get_BITS_19_TO_18_ETC__q3,
	      CASE_hbdg2qabsqabs_response_get_BITS_29_TO_28_ETC__q2,
	      CASE_hbdg2qabsqabs_response_get_BITS_39_TO_38_ETC__q1,
	      CASE_hbdg2qabsqabs_response_get_BITS_9_TO_8_0_ETC__q4;
  wire [194 : 0] _1434766110945527031733894725304609466537681244_ETC__q5,
		 _643371375338640__q6,
		 bs__h16099,
		 bs__h28858;
  wire [15 : 0] x_data__h32135;
  wire [2 : 0] d0__h15725,
	       d10__h15715,
	       d11__h15714,
	       d12__h15713,
  ...
  FIFO2 #(.width(32'd27), .guarded(32'd1)) mdi_fRequest(.RST(sys0_rstn),
							.CLK(sys0_clk),
  ...
  FIFO2 #(.width(32'd17), .guarded(32'd1)) mdi_fResponse(.RST(sys0_rstn),
							 .CLK(sys0_clk),
  ...
  Counter #(.width(32'd8), .init(8'd0)) mdi_rPlayIndex(.CLK(sys0_clk),
						       .RST(sys0_rstn),
  ...
  Counter #(.width(32'd4), .init(4'd6)) mdi_rPrescaler(.CLK(sys0_clk),
						       .RST(sys0_rstn),
  ...
  assign mdi_rMDC_D_IN =
	     _1434766110945527031733894725304609466537681244_ETC__q5[mdi_rPlayIndex_Q_OUT] ;
  assign mdi_rMDC_EN = CAN_FIRE_RL_mdi_run_frame ;

  // register mdi_rMDD
  assign mdi_rMDD_D_IN = bs__h16099[mdi_rPlayIndex_Q_OUT] ;
  assign mdi_rMDD_EN = CAN_FIRE_RL_mdi_run_frame ;

  // register mdi_rOutEn
  assign mdi_rOutEn_D_IN = bs__h28858[mdi_rPlayIndex_Q_OUT] ;
  ...
  assign mdi_vrReadData_0_EN =
	     WILL_FIRE_RL_mdi_run_frame && mdi_rPlayIndex_Q_OUT != 8'd0 &&
	     !mdi_rWrite &&
	     _643371375338640__q6[mdi_rPlayIndex_Q_OUT] ;
  ...
  assign gmac_EN_rx_get = gmac_RDY_rx_get && hbdg2qabs_RDY_qabs_request_put ;
  assign gmac_EN_tx_put = gmac_RDY_tx_put && hbdg2qabs_RDY_qabs_response_get ;
  ...
  assign hbdg2qabs_qabs_request_put =
	     { CASE_gmacrx_get_BITS_39_TO_38_0_gmacrx_get_B_ETC__q7,
	       ...
	       CASE_gmacrx_get_BITS_29_TO_28_0_gmacrx_get_B_ETC__q8,
	       gmac_rx_get[27:20],
	       CASE_gmacrx_get_BITS_19_TO_18_0_gmacrx_get_B_ETC__q9,
	       gmac_rx_get[17:10],
	       CASE_gmacrx_get_BITS_9_TO_8_0_gmacrx_get_BIT_ETC__q10,
	       gmac_rx_get[7:0] } ;
  ...
  assign hbdg2qabs_EN_qabs_request_put = CAN_FIRE_RL_mkConnectionGetPut_22 ;
  assign hbdg2qabs_EN_qabs_response_get = CAN_FIRE_RL_mkConnectionGetPut_21 ;
  ...
  // submodule mdi_fResponse
  assign mdi_fResponse_D_IN = { 1'd1, x_data__h32135 } ;
  ...
  // remaining internal signals
  assign _1434766110945527031733894725304609466537681244_ETC__q5 =
	     195'h2492492492492492492492492492492492492492492492492 ;
  assign _643371375338640__q6 =
  ...
  assign d0__h15725 = {3{mdi_rWriteData[0]}} ;
  assign d10__h15715 = {3{mdi_rWriteData[10]}} ;
  assign d11__h15714 = {3{mdi_rWriteData[11]}} ;
  assign d12__h15713 = {3{mdi_rWriteData[12]}} ;
  assign d13__h15712 = {3{mdi_rWriteData[13]}} ;
  assign d14__h15711 = {3{mdi_rWriteData[14]}} ;
  assign d15__h15710 = {3{mdi_rWriteData[15]}} ;
  assign d1__h15724 = {3{mdi_rWriteData[1]}} ;
  assign d2__h15723 = {3{mdi_rWriteData[2]}} ;
  assign d3__h15722 = {3{mdi_rWriteData[3]}} ;
  assign d4__h15721 = {3{mdi_rWriteData[4]}} ;
  assign d5__h15720 = {3{mdi_rWriteData[5]}} ;
  assign d6__h15719 = {3{mdi_rWriteData[6]}} ;
  assign d7__h15718 = {3{mdi_rWriteData[7]}} ;
  assign d8__h15717 = {3{mdi_rWriteData[8]}} ;
  assign d9__h15716 = {3{mdi_rWriteData[9]}} ;
  ...
  assign forkSndDM1_datagramIngressF_i_notEmpty__1_AND__ETC___d34 =
	     ...
	     (!forkSndDM1_freeF2_EMPTY_N ||
	      ...
	      (!forkSndDM1_datagramIngressF_D_OUT[0] ||
	       forkSndDM1_freeF2_EMPTY_N)) ;
  assign pa0__h15702 = {3{mdi_rPhyAddr[0]}} ;
  assign pa1__h15701 = {3{mdi_rPhyAddr[1]}} ;
  assign pa2__h15700 = {3{mdi_rPhyAddr[2]}} ;
  assign pa3__h15699 = {3{mdi_rPhyAddr[3]}} ;
  assign pa4__h15698 = {3{mdi_rPhyAddr[4]}} ;
  assign ra0__h15708 = {3{mdi_rRegAddr[0]}} ;
  assign ra1__h15707 = {3{mdi_rRegAddr[1]}} ;
  assign ra2__h15706 = {3{mdi_rRegAddr[2]}} ;
  assign ra3__h15705 = {3{mdi_rRegAddr[3]}} ;
  assign ra4__h15704 = {3{mdi_rRegAddr[4]}} ;
  assign x_data__h32135 =
	     { mdi_vrReadData_15,
	       mdi_vrReadData_14,
	       mdi_vrReadData_13,
	       mdi_vrReadData_12,
  ...
  begin
    case (hbdg2qabs_qabs_response_get[39:38])
      ...
      2'd3: CASE_hbdg2qabsqabs_response_get_BITS_39_TO_38_ETC__q1 = 2'd3;
    endcase
  end
  always@(hbdg2qabs_qabs_response_get)
  begin
    case (hbdg2qabs_qabs_response_get[29:28])
      ...
      2'd3: CASE_hbdg2qabsqabs_response_get_BITS_29_TO_28_ETC__q2 = 2'd3;
    endcase
  end
  always@(hbdg2qabs_qabs_response_get)
  begin
    case (hbdg2qabs_qabs_response_get[19:18])
      ...
      2'd3: CASE_hbdg2qabsqabs_response_get_BITS_19_TO_18_ETC__q3 = 2'd3;
    endcase
  end
  always@(hbdg2qabs_qabs_response_get)
  begin
    case (hbdg2qabs_qabs_response_get[9:8])
      ...
      2'd3: CASE_hbdg2qabsqabs_response_get_BITS_9_TO_8_0_ETC__q4 = 2'd3;
    endcase
  end
  always@(gmac_rx_get)
  begin
    case (gmac_rx_get[39:38])
	  ...
	  CASE_gmacrx_get_BITS_39_TO_38_0_gmacrx_get_B_ETC__q7 =
	      gmac_rx_get[39:38];
      2'd3: CASE_gmacrx_get_BITS_39_TO_38_0_gmacrx_get_B_ETC__q7 = 2'd3;
    endcase
  end
  always@(gmac_rx_get)
  begin
    case (gmac_rx_get[29:28])
	  ...
	  CASE_gmacrx_get_BITS_29_TO_28_0_gmacrx_get_B_ETC__q8 =
	      gmac_rx_get[29:28];
      2'd3: CASE_gmacrx_get_BITS_29_TO_28_0_gmacrx_get_B_ETC__q8 = 2'd3;
    endcase
  end
  always@(gmac_rx_get)
  begin
    case (gmac_rx_get[19:18])
	  ...
	  CASE_gmacrx_get_BITS_19_TO_18_0_gmacrx_get_B_ETC__q9 =
	      gmac_rx_get[19:18];
      2'd3: CASE_gmacrx_get_BITS_19_TO_18_0_gmacrx_get_B_ETC__q9 = 2'd3;
    endcase
  end
  always@(gmac_rx_get)
  begin
    case (gmac_rx_get[9:8])
	  ...
	  CASE_gmacrx_get_BITS_9_TO_8_0_gmacrx_get_BIT_ETC__q10 =
	      gmac_rx_get[9:8];
      2'd3: CASE_gmacrx_get_BITS_9_TO_8_0_gmacrx_get_BIT_ETC__q10 = 2'd3;
    endcase
  end
