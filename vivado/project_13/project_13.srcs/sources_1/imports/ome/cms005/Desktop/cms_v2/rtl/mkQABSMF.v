...
//
// On Thu Jun 27 09:42:47 CDT 2013
//
...
module mkQABSMF(et0,
  ...
  wire CAN_FIRE_RL_frk_decide,
       CAN_FIRE_RL_frk_egress,
       CAN_FIRE_RL_frk_stage,
       CAN_FIRE_RL_merge_arbitrate,
       CAN_FIRE_RL_merge_fi0_advance,
       CAN_FIRE_RL_merge_fi1_advance,
  ...
  assign CAN_FIRE_server_request_put = frk_srcF_FULL_N ;
  ...
  assign CAN_FIRE_server_response_get = merge_fo_EMPTY_N ;
  ...
  assign CAN_FIRE_RL_merge_fi0_advance =
	     merge_fi0_EMPTY_N && merge_fo_FULL_N && !merge_fi1Active ;
  assign WILL_FIRE_RL_merge_fi0_advance =
	     CAN_FIRE_RL_merge_fi0_advance && !WILL_FIRE_RL_merge_arbitrate ;

  // rule RL_merge_fi1_advance
  assign CAN_FIRE_RL_merge_fi1_advance =
  ...
  assign CAN_FIRE_RL_merge_arbitrate =
	     merge_fo_FULL_N &&
	     IF_merge_fi0HasPrio_06_THEN_merge_fi0_i_notEmp_ETC___d118 &&
	     merge_fi0_EMPTY_N &&
	     merge_fi1_EMPTY_N &&
	     !merge_fi0Active &&
	     !merge_fi1Active ;
  assign WILL_FIRE_RL_merge_arbitrate = CAN_FIRE_RL_merge_arbitrate ;

  // rule RL_frk_stage
  assign CAN_FIRE_RL_frk_stage =
	     frk_srcF_EMPTY_N && !frk_staged && !frk_decided ;
  assign WILL_FIRE_RL_frk_stage = CAN_FIRE_RL_frk_stage ;

  // rule RL_frk_decide
  assign CAN_FIRE_RL_frk_decide =
	     frk_srcF_EMPTY_N && frk_staged && !frk_decided ;
  assign WILL_FIRE_RL_frk_decide = CAN_FIRE_RL_frk_decide ;

  // rule RL_frk_egress
  assign CAN_FIRE_RL_frk_egress =
	     NOT_frk_stageSent_27_28_OR_frk_srcF_i_notEmpty_ETC___d334 &&
	     frk_staged &&
	     frk_decided ;
  assign WILL_FIRE_RL_frk_egress = CAN_FIRE_RL_frk_egress ;
  ...
  assign frk_match0_EN = CAN_FIRE_RL_frk_decide ;
  ...
  assign frk_sr_D_IN =
	     { IF_frk_srcF_first__79_BITS_39_TO_38_80_EQ_0_81_ETC___d222,
	       ...
	       CASE_frk_sr_BITS_49_TO_48_0_frk_sr_BITS_49_TO__ETC__q44,
	       frk_sr[47:40] } ;
  assign frk_sr_EN = CAN_FIRE_RL_frk_stage ;
