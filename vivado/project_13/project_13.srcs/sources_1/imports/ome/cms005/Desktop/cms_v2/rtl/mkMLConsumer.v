...
//
// On Thu Jun 27 09:42:30 CDT 2013
//
// Method conflict info:
// Method: mesgExpected_put
// Conflict-free: mesgReceived_put, correctCnt
// Conflicts: mesgExpected_put
//
// Method: mesgReceived_put
// Conflict-free: mesgExpected_put, correctCnt
// Conflicts: mesgReceived_put
//
// Method: correctCnt
// Conflict-free: mesgExpected_put, mesgReceived_put, correctCnt
//
//
// Ports:
// Name                         I/O  size props
...
module mkMLConsumer(CLK,
  ...
  // value method correctCnt
  output [3 : 0] correctCnt;
  output RDY_correctCnt;

  // signals for module outputs
  wire [3 : 0] correctCnt;
  wire RDY_correctCnt, RDY_mesgExpected_put, RDY_mesgReceived_put;
  ...
  // value method correctCnt
  assign correctCnt = msgConsumeCnt[3:0] ;
  assign RDY_correctCnt = 1'd1 ;
